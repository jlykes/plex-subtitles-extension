...
<html lang="en">
<head>
    <title>Code coverage report for lib/ssdpHeader.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">lib/</a> ssdpHeader.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span></td><td class="text"><pre class="prettyprint lang-js">var extend = require('extend')
  , random = require('crypto').randomBytes
&nbsp;
function SsdpHeader(method, headers, isResponse) {
  this._method = method
  this._headers = extend ({}, headers || <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>
  this._isResponse = isResponse
  this._id = random(8).toString('hex')
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!this._method) <span class="cstat-no" title="statement not covered" >throw new Error('SSDP header requires method.')</span>
}
&nbsp;
...
SsdpHeader.prototype.setHeader = function (key, value) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (key !== undefined &amp;&amp; value !== undefined) {
    this._headers[key] = value
  }
}
&nbsp;
SsdpHeader.prototype.setHeaders = function (headers) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (headers &amp;&amp; headers.toString &amp;&amp; headers.toString() === '[object Object]') {
...
&nbsp;
module.exports = SsdpHeader</pre></td></tr>
</table></pre>
