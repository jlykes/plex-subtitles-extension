...
app.listen(PORT, () => {
    ...
    console.log(`📱 Access from TV: http://192.168.7.76:${PORT}`);
    console.log(`🔍 DLNA discovery endpoint: http://localhost:${PORT}/discover-dlna`);
});

// Start HTTPS server
https.createServer(httpsOptions, app).listen(HTTPS_PORT, () => {
    console.log(`🔒 HTTPS server running on https://localhost:${HTTPS_PORT}`);
    console.log(`📱 Access from TV: https://192.168.7.76:${HTTPS_PORT}`);
    console.log(`🎯 PWA installation available on HTTPS!`);
